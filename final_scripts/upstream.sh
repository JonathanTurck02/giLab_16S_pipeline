...
qiime dada2 denoise-paired --i-demultiplexed-seqs trimmed-demux.qza --p-trunc-len-f 233 --p-trunc-len-r 231 --o-representative-sequences asv-seqs.qza --o-table feature-table.qza --o-denoising-stats denoising-stats.qza
...
# ================================================== USER INPUT ================== # Insert metadata.txt
# STEP3: Review feature-table and export summ stats to txt
qiime feature-table summarize --i-table feature-table.qza --m-sample-metadata-file phileo_meta.txt --o-visualization feature-table-summ.qzv
...
# ================================================== USER INPUT ================== # User specific path
# STEP5: Classify features with SILVA
qiime feature-classifier classify-consensus-vsearch --i-query asv-seqs.qza --i-reference-reads /scratch/user/jonathanturck/script_bank/silva/rep_set/silva-138-99-seqs.qza --i-reference-taxonomy /scratch/user/jonathanturck/script_bank/silva/taxonomy/silva-138-99-tax.qza --o-classification taxonomy.qza --o-search-results blast_results.qza
